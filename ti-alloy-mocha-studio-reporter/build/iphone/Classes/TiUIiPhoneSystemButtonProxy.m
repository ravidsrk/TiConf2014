...
MAKE_SYSTEM_PROP(ACTIVITY,UICoreNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UICoreNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UICoreNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UICoreNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UICoreNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UICoreNativeItemContactAdd);
