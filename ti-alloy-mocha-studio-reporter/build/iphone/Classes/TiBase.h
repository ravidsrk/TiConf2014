...
// in simulator we redefine to format for Core Developer console
...
{\
	NSString * exceptionName = [@"org.core." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.core";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICoreNativeItemNone = -1, 
	UICoreNativeItemSpinner = -2,
	UICoreNativeItemProgressBar = -3,
	
	UICoreNativeItemSlider = -4,
	UICoreNativeItemSwitch = -5,
	UICoreNativeItemMultiButton = -6,
	UICoreNativeItemSegmented = -7,
	
	UICoreNativeItemTextView = -8,
	UICoreNativeItemTextField = -9,
	UICoreNativeItemSearchBar = -10,
	
	UICoreNativeItemPicker = -11,
	UICoreNativeItemDatePicker = -12,
	
	UICoreNativeItemInfoLight = -13,
	UICoreNativeItemInfoDark = -14,
	
	UICoreNativeItemDisclosure = -15,
	
	UICoreNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Core instances of
